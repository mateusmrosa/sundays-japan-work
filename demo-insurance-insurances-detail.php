...
<div role="main" class="main">
	...
	<section class="page-header page-header-modern section position-relative border-0 m-0" style="background-image: url(img/demos/insurance/backgrounds/background-3.jpg); background-position: center; background-size: cover;">
		<div class="container position-relative pb-5 mb-5">
			...
			<div class="row text-center text-md-start py-2">
				<div class="col p-relative bottom-5">
					...
					<h1 class="font-weight-bold text-color-dark text-10 mt-1 mb-0">Car Insurances</h1>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container custom-container-background custom-z-index-1 py-5">
			<div class="row position-relative z-index-1 pt-5-5">
				<div class="col">
					...
					<img width="120" height="120" src="img/demos/insurance/icons/alloy-wheel.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary float-end ms-3 mb-3'}" />

					<h2 class="text-color-dark font-weight-medium text-8 mb-4-5">You Can <strong>Trust</strong></h2>
					<p class="text-4-5 line-height-8 mb-4">Donec velit magna, consectetur at suscipit eu, dapibus vel odio. Mauris ac nulla at ligula interdum ullamcorper. Nunc mattis eros nec eros dictum, nec molestie metus auctor. Nulla placerat nunc velit, a dictum lectus finibus quis.</p>
					...
					<div class="row justify-content-center gy-5 py-3">
						<div class="col-lg-6">
							<ul class="list list-icons list-icons-style-2 list-icons-lg m-0 p-0">
								<li class="font-weight-bold text-color-dark">
									<i class="fas fa-check text-color-dark border-color-grey-1 top-7 text-3"></i>
									<span class="text-4">Sample Item</span>
								</li>
							</ul>
							<p>Donec velit magna, consectetur at suscipit eu, dapibus vel odio. Mauris ac nulla at ligula interdum ullamcorper. Nunc mattis eros nec eros dictum, nec molestie metus auctor. Nulla placerat nunc velit, a dictum lectus finibus quis. Nunc leo mauris, cursus vel tempor eu, tempus sed turpis.</p>
						</div>
					...
					<h2 class="text-color-dark font-weight-medium text-8 mt-4 mb-2">Our <strong>Clients</strong></h2>

					<figure class="custom-testimonial-style-1 mt-4 pt-2 mb-4">
						<blockquote class="ps-5-5 mb-0">
							<p class="text-4-5 line-height-7 mb-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec velit magna, consectetur at suscipit eu, dapibus vel odio. Mauris ac nulla at ligula interdum ullamcorper.</p>
						</blockquote>
						<figcaption class="font-weight-bold text-color-dark positive-ls-2 ps-5-5 mb-3">JOHN DOE</figcaption>
					</figure>

					<h2 class="text-color-dark font-weight-medium text-8 mt-5 mb-0">Insurance <strong>FAQ's</strong></h2>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col mt-4 mb-4">
					<p class="text-center text-3 mb-0">Porto Insurance © 2022. All Rights Reserved.</p>
				</div>
			</div>
		</div>
	</div>
