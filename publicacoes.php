			...
			<div class="row position-relative z-index-1 pt-5-5">
					...
					<article class="mb-5">
						<div class="card bg-transparent border-0">
							<div class="card-body p-0 z-index-1">
								<a href="demo-insurance-blog-detail.html" data-cursor-effect-hover="plus">
								...
								<div class="card-body p-0">
									<h4 class="card-title text-5 font-weight-bold pb-1 mb-2"><a class="text-color-dark text-color-hover-primary text-decoration-none" href="demo-insurance-blog-detail.html">An Interview with John Doe</a></h4>
					...
					<article class="mb-5">
						<div class="card bg-transparent border-0">
							<div class="card-body p-0 z-index-1">
								...
								<div class="card-body p-0">
									<h4 class="card-title text-5 font-weight-bold pb-1 mb-2"><a class="text-color-dark text-color-hover-primary text-decoration-none" href="demo-insurance-blog-detail.html">How to Grow your Business</a></h4>
									<p class="card-text mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc viverra lorem , consectetur adipiscing elit...</p>
									<a href="demo-insurance-blog-detail.html" class="text-decoration-none custom-link-hover-effects">
										Read More
									</a>
				...
				<div class="blog-sidebar col-lg-4 pt-4 pt-lg-0">
					<aside class="sidebar">
						...
						<div class="px-3 mt-4">
							<h3 class="text-color-dark text-capitalize font-weight-bold text-5 m-0 mb-3">Recent Comments</h3>
							<div class="pb-2 mb-1">
