...
<div role="main" class="main">
    ...
    <section class="page-header page-header-modern section position-relative border-0 m-0" style="background-image: url(img/banner/traducao.jpg); background-position: center; background-size: cover;">
        <div class="container position-relative pb-5 mb-5">
            ...
            <div class="row text-center text-md-start py-2">
                <div class="col p-relative bottom-5">
                    ...
                    <h1 class="font-weight-bold text-color-dark text-10 mt-1 mb-0">Tradução</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section bg-transparent position-relative border-0 m-0 p-0">
        <div class="container custom-container-background custom-z-index-1 py-5">
            <div class="row position-relative z-index-1 pt-5-5">
                <div class="col">
                    <p class="text-4-5 line-height-8 mb-4">Você que deseja um emprego no Japão, nós podemos propiciar-lhe um com toda segurança e estabilidade. Providenciamos vistos e toda documentação paralela para obtenção dele, tais como: tradução de documentos, declarações, registro de documentos no Consulado, enfim, todos os papéis necessários.

                        Está precisando traduzir ou verter documentos?

                        A Sunday’s Japan Work conta com serviço de tradução de documentos do português para o japonês e vice-versa. Entre em contato conosco. Teremos o melhor prazer em atendê-lo..</p>
                </div>
            </div>
        </div>
    </section>
