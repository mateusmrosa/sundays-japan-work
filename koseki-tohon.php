        ...
        <div class="container position-relative pb-5 mb-5">
            ...
            <div class="row text-center text-md-start py-2">
                <div class="col p-relative bottom-5">
                    ...
                    <h1 class="font-weight-bold text-color-dark text-10 mt-1 mb-0">Koseki Tohon</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section bg-transparent position-relative border-0 m-0 p-0">
        <div class="container custom-container-background custom-z-index-1 py-5">
            <div class="row position-relative z-index-1 pt-5-5">
                <div class="col">
                    <p class="text-4-5 line-height-8 mb-4"><b>Koseki Tohon</b> é o documento de registro civil nas Prefeituras onde residiram a família ou antepassados (é considerado apenas para japoneses, comprova a relação de parentesco e a identidade da pessoa).

                        Nele consta o endereço e os nomes dos antepassados, registro de nascimento, de casamento e de óbito.

                        Dispomos de serviços que podem auxiliar os descendentes a obter o Koseki Tohon atualizado. Conte com a Sunday´s Japan Work. Teremos prazer em atendê-lo..</p>
                </div>
            </div>
        </div>
    </section>
