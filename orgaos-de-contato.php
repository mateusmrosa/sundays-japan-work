		...
		<div class="container position-relative pb-5 mb-5">
			...
			<div class="row text-center text-md-start py-2">
				<div class="col p-relative bottom-5">
					<h1 class="font-weight-bold text-color-dark text-10 mt-1 mb-0">Orgãos de Contato</h1>
				</div>
			</div>
		</div>
	</section>
					...
					<div class="row pt-4">
						<div class="col-md-6">
							<div id="teamMember1" class="row align-items-center">
								<h4 class="text-color-dark font-weight-bold line-height-1 text-6 mt-3 mb-2">Embaixada do Japão em Brasília</h4>
								<p class="text-4 line-height-8 mb-3-5"><b>Endereço: </b>Av. das Nações, Quadra 811, lote 39 – Setor de Embaixadas Sul</p>
								<p class="text-4 line-height-8 mb-3-5"><b>Cidade: </b>Brasília Estado: Distrito Federal Cep 70425-900</p>
								<p class="text-4 line-height-8 mb-3-5"><b>Telefone: </b>Telefone: (61) 3442-4200</p>
								<div>
									<p class="mb-0 text-4 line-height-8"><b>E-mail:</b></p>
									<ul>
								...
								<p class="text-4 line-height-8 mb-3-5"><b>Site: </b> <a href="http://www.br.emb-japan.go.jp/" target="_blank">http://www.br.emb-japan.go.jp/</a></p>
								<p class="text-4 line-height-8 mb-3-5"><b>Horário de Atendimento: </b>09h – 12h / 13h30 – 17h30
									de segunda a sexta-feira
									*Exceto feriados</p>
								<p class="text-4 line-height-8 mb-3-5"><b> Atendimento para Solicitação de Visto: </b>9h – 11h30 / 13h30 – 16h
							</div>
						</div>
						<div class="col-md-6">
							<div id="teamMember1" class="row align-items-center">
								<h4 class="text-color-dark font-weight-bold line-height-1 text-6 mt-3 mb-2">Embaixada do Japão em Brasília</h4>
								<p class="text-4 line-height-8 mb-3-5"><b>Endereço: </b>Rua Fortaleza, 416 – B, Adrianópolis</p>
								<p class="text-4 line-height-8 mb-3-5"><b>Cidade: </b>Manaus Estado: Amazonas Cep: 69057-080</p>
								<p class="text-4 line-height-8 mb-3-5"><b>Telefone: </b>(92) 3232-2000 | 3232-8582</p>
								<p class="text-4 line-height-8 mb-3-5"><b>Fax: </b>(92) 3232-6073</p>
								<div>
									<p class="mb-0 text-4 line-height-8"><b>E-mail:</b></p>
									<ul>
										<li>con.japan.manaus@netiu.com.br</li>
										<li>site: <a href="http://www.manaus.br.emb-japan.go.jp/" target="_blank">http://www.manaus.br.emb-japan.go.jp/</a></li>
										<li>Jurisdição: Amazonas, Roraima, Rondônia, Acre</li>
									</ul>
								</div>
							</div>
						</div>
