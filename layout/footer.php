        ...
        <div class="row gy-5">
            <div class="col-md-6">
                <a href="demo-insurance.html" class="text-decoration-none">
                    <img src="img/logo/logo.png" width="123" height="46" class="img-fluid mb-4" alt="Sundays Japan Work" />
                </a>
                <p class="text-3-5 pe-lg-2">Empregos no Japão. </p>
                ...
                <ul class="social-icons social-icons-clean social-icons-medium">
                    ...
                    <li class="social-icons-facebook">
                        <a href="https://www.facebook.com/sundaysjapanwork" target="_blank" title="Facebook">
            ...
            <div class="col-md-6">
                <div class="row mb-5-5">
                    <div class="col-lg-6 mb-4 mb-lg-0">
                        <h4 class="text-color-dark font-weight-bold mb-3">Navegação</h4>
                        <ul class="list list-unstyled columns-lg-2">
                            <li><a href="index.php" class="text-color-grey text-color-hover-primary">Home</a></li>
                            <li><a href="preencher-curriculum.php" class="text-color-grey text-color-hover-primary">Preencher Curriculum</a></li>
                            <li><a href="empresa.php" class="text-color-grey text-color-hover-primary">Empresa</a></li>
                            <li><a href="servicos.php" class="text-color-grey text-color-hover-primary">Serviços</a></li>
                            <li><a href="informacoes.php" class="text-color-grey text-color-hover-primary">Informações</a></li>
                            <li><a href="videos.php" class="text-color-grey text-color-hover-primary">Vídeos</a></li>
                            <li><a href="publicacoes.php" class="text-color-grey text-color-hover-primary">Publicações</a></li>
                        </ul>
                    </div>
                    <div class="col-lg-6">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col mt-4 mb-4">
                    <p class="text-center text-3 mb-0"><b>© Sundays Japan Work </b> - <?php echo date('d/m/Y'); ?>.
                        Todos direitos reservados. Desenvolvido por
                        <span>
                            <a href="https://api.whatsapp.com/send?1=pt_BR&phone=5518981483133" target="_black">
                                <b style="color: #f81f1f ">Mateus Rosa</b>
                            </a>
                        </span>
                    </p>
                </div>
