	...
	<section class="section bg-transparent position-relative border-0 m-0 p-0">
		<div class="container custom-container-background custom-z-index-1 py-5">
			<div class="row position-relative z-index-1 pt-5-5">
				<div class="col">
					<p class="text-4-5 line-height-8 mb-4">A empresa <b>Sunday’s Japan Work</b> foi fundada em meados de <b>1994</b>, com o objetivo principal de recrutar <b>mão de obra</b> para suprir o 
					<b>mercado</b> de trabalho <b>Japonês</b>, oferecendo empregos de acordo com as preferências pessoais de cada cliente, com <b>estabilidade, assistência</b> e <b>segurança</b> em grande <b>variedades</b> e <b>tipos</b> de serviços, praticamente em <b>todo território japonês.</b></p>

					<p class="text-4-5 line-height-8 mb-4">Na seleção dos candidatos, verificamos o perfil de cada interessado cuidadosamente. Levamos em conta: a idade, o sexo, aptidão, experiência profissional, nível de entendimento do idioma japonês, saúde, nível escolar, etc...</p>

					<p class="text-4-5 line-height-8 mb-4">Assessoramos os candidatos antes, durante e depois do embarque, para que eles possam viajar tranquilos e sem preocupação.</p>

<!-- 
					<div class="row counters text-dark ps-lg-4">
						<div class="col-md-3 mb-5-5">
	...
	<!-- <section class="section section-height-3 border-0 m-0">
		<div class="container">
			<div class="row">
				<div class="col">
					<h2 class="text-color-dark font-weight-medium text-8 mb-4">Our <strong>Story</strong></h2>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-3">
					<div class="tabs tabs-vertical tabs-right tabs-navigation tabs-navigation-simple">
						<ul class="nav nav-tabs col-sm-3">
							<li class="nav-item">
								<a class="nav-link active" href="#tabsNavigationVertSimple1" data-bs-toggle="tab"><strong class="text-8 d-block text-end py-2 pe-4">2000</strong></a>
							</li>
							<li class="nav-item">
								<a class="nav-link" href="#tabsNavigationVertSimple2" data-bs-toggle="tab"><strong class="text-8 d-block text-end py-2 pe-4">2002</strong></a>
							</li>
							<li class="nav-item">
								<a class="nav-link" href="#tabsNavigationVertSimple3" data-bs-toggle="tab"><strong class="text-8 d-block text-end py-2 pe-4">2006</strong></a>
							</li>
							<li class="nav-item">
								<a class="nav-link" href="#tabsNavigationVertSimple4" data-bs-toggle="tab"><strong class="text-8 d-block text-end py-2 pe-4">2012</strong></a>
							</li>
							<li class="nav-item">
								<a class="nav-link" href="#tabsNavigationVertSimple5" data-bs-toggle="tab"><strong class="text-8 d-block text-end py-2 pe-4">2020</strong></a>
							</li>
						</ul>
					</div>
				</div>
				<div class="col-lg-9">
					<div class="tab-pane tab-pane-navigation active" id="tabsNavigationVertSimple1">
						...
						<img class="float-start img-fluid rounded-circle me-4 mb-4" width="200" src="img/demos/insurance/generic/generic-1.jpg" alt="">
					...
					<div class="tab-pane tab-pane-navigation" id="tabsNavigationVertSimple2">
						<h4>Company Fact</h4>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur pellentesque neque eget diam posuere porta. Quisque ut nulla at nunc <a href="#">vehicula</a> lacinia.</p>
						<p>Lorem ipsum dolor sit amet, uisque ut nulla at nunc <a href="#">vehicula</a> lacinia. Proin adipiscing porta tellus, ut feugiat nibh adipiscing sit amet. In eu justo a felis faucibus ornare vel id metus. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; In eu libero ligula. Fusce eget metus lorem, ac viverra leo. Nullam convallis, arcu vel pellentesque sodales, nisi est varius diam, ac ultrices sem ante quis sem. Proin ultricies volutpat sapien, nec scelerisque ligula mollis lobortis.</p>
					</div>
					<div class="tab-pane tab-pane-navigation" id="tabsNavigationVertSimple3">
						<h4>Company Fact</h4>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur pellentesque neque eget diam posuere porta. Quisque ut nulla at nunc <a href="#">vehicula</a> lacinia.</p>
						<img class="float-start img-fluid rounded-circle me-4 mb-4" width="200" src="img/demos/insurance/generic/generic-2.jpg" alt="">
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur pellentesque neque eget diam posuere porta. Quisque ut nulla at nunc <a href="#">vehicula</a> lacinia. Proin adipiscing porta tellus, ut feugiat nibh adipiscing sit amet. In eu justo a felis faucibus ornare vel id metus. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; In eu libero ligula. Fusce eget metus lorem, ac viverra leo. Nullam convallis, arcu vel pellentesque sodales, nisi est varius diam, ac ultrices sem ante quis sem. Proin ultricies volutpat sapien, nec scelerisque ligula mollis lobortis.</p>
					</div>
