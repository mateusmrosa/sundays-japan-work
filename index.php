...
<div role="main" class="main">
	...
	<section class="section position-relative border-0 m-0" style="background-image: url(img/banner/japao.png); background-position: center; background-size: cover;">
		<div class="container position-relative pb-5 mb-5">
			...
			<!-- <img src="img/demos/insurance/generic/generic-3.png" class="img-fluid position-absolute top-10 right-0 z-index-1 d-none d-lg-block appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="100" alt="Woman Hero" /> -->
		...
		<div class="container custom-container-background z-index-1 py-5">
			<!-- <div class="row position-relative z-index-1 pt-5-5">
				<div class="col text-center">
					<h2 class="text-color-dark font-weight-medium text-8 mb-5-5">O <strong>Porto Insurance?</strong></h2>
				</div>
			</div> -->
			<!-- <div class="row justify-content-center position-relative gy-5 z-index-1">
				<div class="col-md-9 col-lg-4 text-center appear-animation" data-appear-animation="fadeInLeftShorterPlus" data-appear-animation-delay="100">
					<img width="90" height="90" src="img/demos/insurance/icons/rounded-dollar.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-secondary mb-4-5'}" />
				...
				<div class="col-md-9 col-lg-4 text-center appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="100">
					<img width="90" height="90" src="img/demos/insurance/icons/mouse-dollar.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-stroke-color-primary mb-4-5'}" />
				...
				<div class="col-md-9 col-lg-4 text-center appear-animation" data-appear-animation="fadeInRightShorterPlus" data-appear-animation-delay="100">
					<img width="90" height="90" src="img/demos/insurance/icons/money-suitcase.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-stroke-color-secondary mb-4-5'}" />
			...
			<div class="row align-items-center pb-5 pb-lg-0 mb-5 mb-lg-0">
				<div class="col-lg-5 text-center text-lg-start appear-animation" data-appear-animation="fadeInRightShorterPlus" data-appear-animation-delay="100">
					<img src="img/banner/brasil-japao.png" class="img-fluid rounded-circle mb-4 mb-lg-0" alt="" />
				</div>
				<div class="col-lg-6 text-center text-lg-start appear-animation" data-appear-animation="fadeInRightShorterPlus" data-appear-animation-delay="100">
					<h2 class="text-color-dark font-weight-medium text-8 mb-4-5">Seu guia no <strong> Japão</strong></h2>
					<p class="text-3-5 line-height-8 mb-4">Pequeno manual do brasileiro no Japão. </p>
					<a href="https://drive.google.com/file/d/1PUj-0qgtM63UzX0g7DQWwVQfrghX7vAh/view" target="_blank" class="btn btn-secondary btn-outline btn-rounded font-weight-bold btn-px-5 py-3">VER MAIS</a>
				</div>
			</div>
			<div class="row align-items-center pt-1 my-5">
				<div class="col-lg-6 text-center text-lg-start order-2 order-lg-1 appear-animation" data-appear-animation="fadeInLeftShorterPlus" data-appear-animation-delay="100">
					<h2 class="text-color-dark font-weight-medium text-8 mb-4-5">Manual do Empreendedor brasileiro no <strong> Japão</strong></h2>
					<a href="https://drive.google.com/file/d/1rmHSbkSDYvpzL-wFTUT1jVRYOstl_Kfm/view" target="_blank" class="btn btn-secondary btn-outline btn-rounded font-weight-bold btn-px-5 py-3">VER MAIS</a>
				</div>
				<div class="col-lg-5 text-center text-lg-end order-1 order-lg-2">
					<img src="img/banner/manual-empreendedor.png" class="img-fluid rounded-circle mb-4 mb-lg-0 appear-animation" data-appear-animation="fadeInLeftShorterPlus" data-appear-animation-delay="100" alt="" />
				</div>
			</div>
		</div>
	...
	<section class="section section-height-3 border-0 m-0">
		<div class="container pb-3">
			<div class="row">
				<div class="col text-center">
					<h2 class="text-color-dark font-weight-medium text-8 mb-5 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="100">Mapa do <strong>Japão</strong></h2>
				</div>
			</div>
			<div class="row justify-content-center gy-5 mb-5">
				...
				<div class="col-9 col-sm-10 col-md-7 col-lg-6 col-xl-3 text-center appear-animation" data-appear-animation="fadeInLeftShorterPlus" data-appear-animation-delay="100">
					<img width="90" height="90" src="img/demos/insurance/icons/travel-case.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary mb-3'}" />
				...
				<div class="col-9 col-sm-10 col-md-7 col-lg-6 col-xl-3 text-center appear-animation" data-appear-animation="fadeInRightShorterPlus" data-appear-animation-delay="100">
					<img width="90" height="90" src="img/demos/insurance/icons/hearts.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary mb-3'}" />
				...
				<div class="col-9 col-sm-10 col-md-7 col-lg-6 col-xl-3 text-center appear-animation" data-appear-animation="fadeInRightShorterPlus" data-appear-animation-delay="100">
					<img width="90" height="90" src="img/demos/insurance/icons/alloy-wheel.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary mb-3'}" />
		...
		<div class="container">
			<div class="row align-items-center gy-5">
				<div class="col-xl-7 text-center text-xl-start">
					<h3 class="text-color-light font-weight-medium text-4 mb-1">Horário de Atendimento</h3>
					<h2 class="text-color-light font-weight-bold mb-1">De segunda à sexta-feira</h2>
					<p class="text-color-light font-weight-semibold opacity-8 text-4 mb-0">Das 09:00 horas ás 12:00, Das 14:00 horas ás 18:00. </p>
				</div>
				<div class="col-xl-5">
					<div class="d-flex flex-column flex-sm-row align-items-center justify-content-center justify-content-xl-end">
						<div class="d-inline-flex align-items-center mb-4 mb-sm-0">
							...
							<div class="ps-2">
								<span class="d-block text-2 font-weight-medium text-color-light line-height-1">LIGUE AGORA</span>
								<strong class="text-4"><a href="tel:+1234567890" class="text-color-light text-decoration-none">(18) 3222-4299</a></strong>
							</div>
						</div>
						<div class="custom-divider px-3 me-3 ms-5-5 d-none d-sm-block"></div>
						<a href="contato.php" class="btn btn-light btn-rounded font-weight-bold border-0 text-color-dark text-3 px-5 btn-py-3">CONTATO</a>
					</div>
				</div>
			</div>
		</div>
