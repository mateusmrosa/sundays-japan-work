...
<div role="main" class="main">
		...
		<div class="container custom-container-background custom-z-index-1 py-5">
			<div class="row position-relative z-index-1 pt-5-5">
				<div class="col">
					...
					<h2 class="text-color-dark font-weight-medium text-8 mb-4-5">A empresa <strong>Sunday’s Japan Work</strong></h2>
					<p class="text-4-5 line-height-8 mb-4">Atua há mais de 20 anos no mercado, atende as áreas de recrutamento e seleção de pessoas. oferecendo empregos de acordo com as preferências pessoais de cada cliente, com estabilidade, assistência e segurança em grande variedades e tipos de serviços, praticamente em todo território japonês.

						Na seleção dos candidatos, verificamos o perfíl de cada interessado cuidadosamente. Levamos em conta: a idade, o sexo, aptidão, experiência profissional, nível de entendimento do idioma japonês, saúde, nível escolar, etc.</p>

					<p>Aqui segue uma lista com os serviços que disponibilizamos para você.</p>

					<div class="row justify-content-center gy-5 py-5">
						<div class="col-lg-6 text-center appear-animation" data-appear-animation="fadeInLeftShorterPlus" data-appear-animation-delay="100">
							...
							<h3 class="text-color-dark font-weight-bold text-transform-none text-5 mb-4-5">Empregos</h3>
							<p class="text-3-5 px-lg-5 mx-lg-5">A Sunday’s Japan Work mantém parceria com inúmeras empresas japonesas, entre empreiteiras e fábricas para serviços diretos sem intermediários.</p>
							<a href="empregos.php" class="text-decoration-none custom-link-hover-effects pb-5">
								<span class="custom-view-more d-inline-flex font-weight-semibold text-color-primary">
									Ver Mais
									<img width="27" height="27" src="img/demos/insurance/icons/arrow-right.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary ms-2'}" style="width: 27px;" />
								</span>
							</a>
						</div>
						<div class="col-lg-6 text-center appear-animation" data-appear-animation="fadeInLeftShorterPlus" data-appear-animation-delay="100">
							<img width="90" height="90" src="img/demos/insurance/icons/casa.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary mb-3'}" />
							<h3 class="text-color-dark font-weight-bold text-transform-none text-5 mb-4-5">Traduções</h3>
							<p class="text-3-5 px-lg-5 mx-lg-5">A Sunday’s Japan Work conta com serviço de tradução de documentos do português para o japonês e vice-versa. Entre em contato conosco. Teremos o melhor prazer em atendê-lo.</p>
							<a href="traducao.php" class="text-decoration-none custom-link-hover-effects pb-5">
								<span class="custom-view-more d-inline-flex font-weight-semibold text-color-primary">
									Ver Mais
									<img width="27" height="27" src="img/demos/insurance/icons/arrow-right.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary ms-2'}" style="width: 27px;" />
								</span>
						...
						<div class="col-lg-6 text-center appear-animation" data-appear-animation="fadeInRightShorterPlus" data-appear-animation-delay="100">
							<img width="90" height="90" src="img/demos/insurance/icons/casa.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary mb-3'}" />
							<h3 class="text-color-dark font-weight-bold text-transform-none text-5 mb-4-5">KOSEKI TOHON</h3>
							<p class="text-3-5 px-lg-5 mx-lg-5">Dispomos de serviços que podem auxiliar os descendentes a obter o Koseki Tohon atualizado. Conte com a Sunday´s Japan Work. Teremos prazer em atendê-lo.</p>
							<a href="koseki-tohon.php" class="text-decoration-none custom-link-hover-effects pb-5">
								<span class="custom-view-more d-inline-flex font-weight-semibold text-color-primary">
									Ver Mais
									<img width="27" height="27" src="img/demos/insurance/icons/arrow-right.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary ms-2'}" style="width: 27px;" />
								</span>
						...
						<div class="col-lg-6 text-center appear-animation" data-appear-animation="fadeInRightShorterPlus" data-appear-animation-delay="100">
							<img width="90" height="90" src="img/demos/insurance/icons/casa.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary mb-3'}" />
							<h3 class="text-color-dark font-weight-bold text-transform-none text-5 mb-4-5">SHAKAI HOKEN</h3>
							<p class="text-3-5 px-lg-5 mx-lg-5">Shakai Hoken é um Sistema de Seguro Social do Japão, segundo a lei japonesa, todo trabalhador assalariado deve estar registrado no mesmo </p>
							<a href="shakai-hoken.php" class="text-decoration-none custom-link-hover-effects pb-5">
								<span class="custom-view-more d-inline-flex font-weight-semibold text-color-primary">
									Ver Mais
									<img width="27" height="27" src="img/demos/insurance/icons/arrow-right.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary ms-2'}" style="width: 27px;" />
								</span>
						...
						<div class="col-lg-6 text-center appear-animation" data-appear-animation="fadeInRightShorterPlus" data-appear-animation-delay="100">
							<img width="90" height="90" src="img/demos/insurance/icons/casa.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary mb-3'}" />
							<h3 class="text-color-dark font-weight-bold text-transform-none text-5 mb-4-5">Visto e certificado de elegibilidade</h3>
							<p class="text-3-5 px-lg-5 mx-lg-5">Entre em contato conosco para tirarmos suas dúvidas restantes, nós da Sunday’s Japan Work teremos um grande prazer de poder ajudá-lo. </p>
							<a href="visto-cert-elegibilidade.php" class="text-decoration-none custom-link-hover-effects pb-5">
								<span class="custom-view-more d-inline-flex font-weight-semibold text-color-primary">
									Ver Mais
									<img width="27" height="27" src="img/demos/insurance/icons/arrow-right.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary ms-2'}" style="width: 27px;" />
								</span>
						...
						<div class="col-lg-6 text-center appear-animation" data-appear-animation="fadeInRightShorterPlus" data-appear-animation-delay="100">
							<img width="90" height="90" src="img/demos/insurance/icons/casa.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary mb-3'}" />
							<h3 class="text-color-dark font-weight-bold text-transform-none text-5 mb-4-5">Restituição de imposto de renda</h3>
							<p class="text-3-5 px-lg-5 mx-lg-5">Providenciamos a solicitação de restituição de Imposto de Renda.</p>
						</div>
						<div class="col-lg-6 text-center appear-animation" data-appear-animation="fadeInRightShorterPlus" data-appear-animation-delay="100">
							<img width="90" height="90" src="img/demos/insurance/icons/casa.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary mb-3'}" />
						...
						<div class="col-lg-6 text-center appear-animation" data-appear-animation="fadeInRightShorterPlus" data-appear-animation-delay="100">
							<img width="90" height="90" src="img/demos/insurance/icons/casa.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary mb-3'}" />
							<h3 class="text-color-dark font-weight-bold text-transform-none text-5 mb-4-5">Passaporte Japonês</h3>
							<p class="text-3-5 px-lg-5 mx-lg-5">Providenciamos passaporte junto ao Consulado Japonês.</p>
						</div>
						<div class="col-lg-12 text-center appear-animation" data-appear-animation="fadeInRightShorterPlus" data-appear-animation-delay="100">
							<img width="90" height="90" src="img/demos/insurance/icons/casa.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary mb-3'}" />
							<h3 class="text-color-dark font-weight-bold text-transform-none text-5 mb-4-5">Satisfação</h3>
							<p class="text-3-5 px-lg-5 mx-lg-5">O nível de satisfação de nossos candidatos é um dos melhores do mercado. Comumente recebemos apresentações de novos candidatos, parentes, amigos e conhecidos dos que viajaram conosco, o que nos motiva e incentiva a continuar prestando serviços de qualidade a coletividade Nikkei.</p>
						</div>
					</div>
				</div>
			</div>
	...
	<!-- <section class="section position-relative overflow-hidden section-height-3 border-0 m-0" data-plugin-parallax data-plugin-options="{'speed': 1.5, 'parallaxHeight': '120%', 'fadeIn': true}" data-image-src="img/demos/insurance/backgrounds/background-2.jpg">
