...
<div role="main" class="main">
    ...
    <section class="page-header page-header-modern section position-relative border-0 m-0" style="background-image: url(img/banner/koseki_sample.jpg); background-position: center; background-size: cover;">
        <div class="container position-relative pb-5 mb-5">
            ...
            <div class="row text-center text-md-start py-2">
                <div class="col p-relative bottom-5">
                    ...
                    <h1 class="font-weight-bold text-color-dark text-10 mt-1 mb-0">Shakai Hoken</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section bg-transparent position-relative border-0 m-0 p-0">
        <div class="container custom-container-background custom-z-index-1 py-5">
            <div class="row position-relative z-index-1 pt-5-5">
                <div class="col">
                    <p class="text-4-5 line-height-8 mb-4"><b>Shakai Hoken</b> é um Sistema de Seguro Social do Japão, segundo a lei japonesa, todo trabalhador assalariado deve estar registrado no mesmo. 
                    Ele é executado da seguinte forma: Após a saída do Japão, quem contribuiu por mais de seis meses, tem o direito de uma restituição monetária; o prazo máximo para solicitar o resgate é de dois anos.</p>
                    <p class="text-4-5 line-height-8 mb-4"><b>Para fazer a restituição é necessário somente os seguintes documentos:</b></p>
                    <div>
                        <ul>
                            <li>Cópia de todos os passaportes, inclusive cancelados (págs. 1, 2, 3 e págs. com carimbo de datas de entradas e saídas e vistos, legíveis).</li>
                            <li>Cópia simples de RG e CPF.</li>
                            <li>Cópia simples do cartão de conta corrente de banco (no Brasil) frente e verso.</li>
                            <li>Cópia simples do Gaikokujin Torooku (frente e verso) ou cópia de um comprovante do ultimo endereço do Japão (contas de consumo, correspondências, carteira de motorista, carnê de imposto municipal).</li>
                            <li>Caderneta original do Shakai (Nenkin Techoo) — Caderneta azul ou laranja.</li>
                            <li>Cópia de algum guensen do ano que contribuiu com o shakai ou holerites (1º e último mês pago).</li>
                            <li>Documentos necessários para a elaboração da 2ª parte do Shakai Hoken: 
                                <ul>
                                    <li>O último passaporte (cópia das páginas 0, 1, 2,3 e das páginas que constarem selos, carimbos e anotações)</li>
                                    <li>Notificação parte maior (Original)</li>
                                    <li>Cartão do banco (cópia simples frente e verso)</li>
                                    <li>Comprovante de residência do Japão Zairyu Card (cópia frente e verso).</li>
                                    <li><b>OBS:</b> Há empresa que pedem holerite, gensen, certidão de Nascimento entre outros documentos. (Com esses documentos a empresa restitui também o imposto e acaba não repassando ao solicitante)</li>
                                    <li>Providenciamos a sua restituição aqui no Brasil.</li>
                                    <li>Conte conosco para análise do seu perfil. Podemos propiciar-lhe um bom emprego no mercado de trabalho Japonês.</li>
                                </ul>
                            </li>
                        </ul>
                    </div>
