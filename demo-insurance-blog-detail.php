		...
		<div class="container position-relative pb-5 mb-5">
			...
			<div class="row text-center text-md-start py-2">
				<div class="col p-relative bottom-5">
					...
					<h1 class="font-weight-bold text-color-dark text-10 mt-1 mb-0">Blog</h1>
				</div>
			</div>
		</div>
	</section>
											...
											<div class="p-2">
												...
												<div class="row">
													<div class="form-group col mb-0">
														<button type="submit" class="btn btn-secondary btn-rounded border-0 font-weight-bold text-3 btn-px-5 py-3" data-loading-text="Loading..." data-cursor-effect-hover="plus" data-cursor-effect-hover-color="light">
